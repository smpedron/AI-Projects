...
const level_of_uncertainty = [
  "The outcome of the system is uncertain"
];
...
const system_track_record = [
  "Given the system's track record, I have good reason to doubt it's competence"
];
...
const user_interface = [
  ...
  "I believe that the system is a competent performer"
    ...
    setRandomQuestions('adaptability', adaptability, 1);
    ...
    setRandomQuestions('level_of_uncertainty', level_of_uncertainty, 1);
    ...
    setRandomQuestions('system_track_record', system_track_record, 1);
    setRandomQuestions('time_constraints', time_constraints, 1);
...
const selectedAdaptability = getRandomItems(adaptability, 1);
...
Qualtrics.SurveyEngine.setEmbeddedData('adaptability_1', selectedAdaptability[0]);
...
Qualtrics.SurveyEngine.setEmbeddedData('level_of_uncertainty_1', selectedLevelOfUncertainty[0]);
...
Qualtrics.SurveyEngine.setEmbeddedData('system_track_record_1', selectedSystemTrackRecord[0]);
Qualtrics.SurveyEngine.setEmbeddedData('time_constraints_1', selectedTimeConstraints[0]);
